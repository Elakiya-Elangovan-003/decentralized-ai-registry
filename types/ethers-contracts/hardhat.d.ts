...
declare module "@nomicfoundation/hardhat-ethers/types" {
  ...
  getContractFactory(name: 'AIModelRegistry', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.AIModelRegistry__factory>
...
getContractFactory(name: 'MockToken', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.MockToken__factory>
  ...
  getContractAt(name: 'AIModelRegistry', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.AIModelRegistry>
...
getContractAt(name: 'MockToken', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.MockToken>
  ...
  deployContract(name: 'AIModelRegistry', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.AIModelRegistry>
...
deployContract(name: 'MockToken', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.MockToken>
  ...
  deployContract(name: 'AIModelRegistry', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.AIModelRegistry>
